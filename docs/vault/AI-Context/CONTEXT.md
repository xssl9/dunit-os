...
- PIT/IPC wait queues блокируют потоки; GUI apps ждут IPC events без yield polling. Нет TLS, общего handle/event readiness, futex-like wait/wake и SMP; thread join пока неблокирующий.
