...
impl VirtualMemoryManager {
    ...
    fn ensure_table_hierarchy(&mut self, virt: VirtualAddress) {
        ...
        if p4_entry.is_unused() {
            ...
            p4_entry.set(PhysicalAddress(p3_addr), PageFlags::PRESENT | PageFlags::WRITABLE);
        ...
        if p3_entry.is_unused() {
            ...
            p3_entry.set(PhysicalAddress(p2_addr), PageFlags::PRESENT | PageFlags::WRITABLE);
        ...
        if p2_entry.is_unused() {
            ...
            p2_entry.set(PhysicalAddress(p1_addr), PageFlags::PRESENT | PageFlags::WRITABLE);
